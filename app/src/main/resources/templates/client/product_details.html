            ...
            <div class="row justify-content-center">
                ...
                <div class="product_img_slide owl-carousel">
                    <div class="single_product_img">
                        <img src="client/assets/img/gallery/gallery1.png" alt="#" class="img-fluid">
                    </div>
                    <div class="single_product_img">
                        <img src="client/assets/img/gallery/gallery01.png" alt="#" class="img-fluid">
                    </div>
                    <div class="single_product_img">
                        <img src="client/assets/img/gallery/gallery1.png" alt="#" class="img-fluid">
                    </div>
  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>                   
    ...
    <!-- JS here -->
        ...
        <script src="client/assets/js/swiper.min.js"></script>
            <!-- swiper js -->
        <script src="client/assets/js/mixitup.min.js"></script>
